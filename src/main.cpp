...
int main() {
	...
	inputCapture.open("VID_20140224_222626.mp4"); //0);
...
//			convert << cameraPos;
//			putText(view, convert.str().c_str(), Point2f(10, 20), 1, 1,
//					Scalar(0, 255, 0), 2);
//
//			convert.str("tvec: ");
//			convert << tvec;
//			putText(view, convert.str().c_str(), Point2f(10, 40), 1, 1,
//					Scalar(0, 255, 0), 2);
//
//			convert.str("rvec: ");
//			convert << rvec / M_PI * 180;
//			putText(view, convert.str().c_str(), Point2f(10, 60), 1, 1,
//					Scalar(0, 255, 0), 2);

			vector<Point2d> output;
			projectPoints(axises, rvec, tvec, cameraMatrix, distCoeffs, output);

			//circle(view, Point(view.cols / 2, view.rows / 2), 2,
			//		Scalar(0, 255, 0), 2);
